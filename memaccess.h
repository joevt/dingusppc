...
#define READ_QWORD_BE_U(addr)                                                  \
    ((uint64_t(((uint8_t*)(addr))[0]) << 56) | (uint64_t(((uint8_t*)(addr))[1]) << 48) | \
     ...
     (uint64_t(((uint8_t*)(addr))[4]) << 24) | (uint64_t(((uint8_t*)(addr))[5]) << 16) | \
     (uint64_t(((uint8_t*)(addr))[6]) <<  8) | (uint64_t(((uint8_t*)(addr))[7])      ) )
...
#define READ_QWORD_LE_U(addr)                                                  \
    ((uint64_t(((uint8_t*)(addr))[7]) << 56) | (uint64_t(((uint8_t*)(addr))[6]) << 48) | \
     ...
     (uint64_t(((uint8_t*)(addr))[3]) << 24) | (uint64_t(((uint8_t*)(addr))[2]) << 16) | \
     (uint64_t(((uint8_t*)(addr))[1]) <<  8) | (uint64_t(((uint8_t*)(addr))[0])      )  )
