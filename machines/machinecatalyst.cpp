...
static const PropMap pm7200_settings = {
    {"rambank1_size", new IntProperty( 8, std::vector<uint32_t>({0, 2, 4, 8, 16, 32, 64, 128, 256, 512}))},
    {"rambank2_size", new IntProperty( 0, std::vector<uint32_t>({0, 2, 4, 8, 16, 32, 64, 128, 256, 512}))},
    {"rambank3_size", new IntProperty( 0, std::vector<uint32_t>({0, 2, 4, 8, 16, 32, 64, 128, 256, 512}))},
    {"rambank4_size", new IntProperty( 0, std::vector<uint32_t>({0, 2, 4, 8, 16, 32, 64, 128, 256, 512}))},
    {"emmo",
        new BinProperty(0)},
    {"cpu",
