...
int initialize_catalyst(std::string& id)
{
    ...
    // insert RAM DIMMs
    platinum_obj->insert_ram_dimm(0, GET_INT_PROP("rambank1_size") * (1<<20));
    platinum_obj->insert_ram_dimm(1, GET_INT_PROP("rambank2_size") * (1<<20));
    platinum_obj->insert_ram_dimm(2, GET_INT_PROP("rambank3_size") * (1<<20));
    platinum_obj->insert_ram_dimm(3, GET_INT_PROP("rambank4_size") * (1<<20));
