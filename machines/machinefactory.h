...
public:
    ...
    static HWComponent* create_device(HWComponent *parent, std::string dev_name, HWCompType supported_types = HWCompType::UNKNOWN);
...
private:
    static void print_settings(const PropMap& p, PropScope scope, int indent, std::string path, std::string device, std::set<std::string> *properties);
    static void list_device_settings(DeviceDescription& dev, PropScope scope, int indent, std::string path, std::string device, std::set<std::string> *properties);
