...
static const std::map<int,PciIrqMap> grackle_irq_map = {
    ...
    {DEV_FUN(0x10,0), {nullptr    ,                  }}, // Paddington I/O controller
...
static const PropMap name ## _settings = { \
    {"rambank1_size", new IntProperty(128, std::vector<uint32_t>({0, 8, 16, 32, 64, 128, 256, 512, 1024}))}, \
    {"rambank2_size", new IntProperty(128, std::vector<uint32_t>({0, 8, 16, 32, 64, 128, 256, 512, 1024}))}, \
