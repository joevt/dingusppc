...
static const PropMap bondi_settings = {
    {"rambank1_size",
        new IntProperty(128, std::vector<uint32_t>({32, 64, 128}))},
    {"emmo",
        new BinProperty(0)},
    {"hdd_config",
...
static std::vector<std::string> bondi_devices = {
    "GrackleBondi@80000000", "BurgundySnd@14000", "Heathrow@10", "AtiMach64Gx@12"
};

static const DeviceDescription MachineBondi_descriptor = {
    Machine::create<MachineBondi>, bondi_devices, bondi_settings, HWCompType::MACHINE, "iMac G3 Bondi Blue"
};
