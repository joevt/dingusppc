...
#define rom(version, checksum, checksum64, id, dppc_mach, dppc_desc, rom_desc) \
    ...
    rom( 0x077d28f2, 0x962f6c13, 0xc60da96de537f08a, "Boot TNT 0.1p..]", "ans700"  , "Apple Network Server series", "Apple Network Server 300, 500, 700 v1.1.20.1"      )
    rom( 0x077d28f2, 0x962f6c13, 0xd540b3dd5bcf9caa, "Boot TNT 0.1p..]", "ans700"  , "Apple Network Server series", "Apple Network Server 300, 500, 700 v1.1.22"        )
    rom( 0x077d28f2, 0x9630c68b, 0xa71fb907dd180b8a, "Boot TNT 0.1p..]", "ans700"  , "Apple Network Server series", "Apple Network Server 300, 500, 700 v2.26B6"        )
    rom( 0x077d28f2, 0x962f6c13, 0x50348b3d0126096b, "Boot TNT 0.1p..]", "ans700"  , "Apple Network Server series", "Apple Network Server 300, 500, 700 v2.26NT"        )
    rom( 0x077d7dd0, 0x49b2be8f, 0x5f2aeeb25507b2cb, "Boot TNT 0.1p..]", "ans700"  , "Apple Network Server series", "Apple Network Server 300, 500, 700 v2.0"           )
