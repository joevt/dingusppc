...
static const map<string, string> PropHelp = {
    ...
    {"rambank13_size",   "specifies RAM bank 13 size in MB"},
    ...
    {"pci_J11",         "insert a PCI device into 64-bit 33MHz J11 slot"},
    {"pci_J10",         "insert a PCI device into 64-bit 33MHz J10 slot"},
    {"pci_J9",          "insert a PCI device into 64-bit 33MHz J9 slot"},
    {"pci_FireWire",    "insert a PCI device into PCI slot reserved for Yosemite FireWire"},
    {"pci_ATA",         "insert a PCI device into PCI slot reserved for Yosemite ATA"},
...
{
    LOG_F(INFO, "[ Creating device %s", dev_name.c_str());
