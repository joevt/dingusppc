...
#define static_const_ans_settings(cpu) \
static const PropMap ans_settings_ ## cpu = { \
    static_const_tnt_common_settings(cpu) \
    ...
    {"two_supplies", new BinProperty(1)}, \
};

static_const_tnt_settings(601)
static_const_tnt_settings(604)
static_const_tnt_settings(604e)
static_const_ans_settings(604)
static_const_ans_settings(604e)
...
static const DeviceDescription MachineAns500_descriptor = {
    Machine::create<MachineTnt>, pmAns_devices, ans_settings_604, HWCompType::MACHINE,
    "Apple Network Server 500"
};

static const DeviceDescription MachineAns700_descriptor = {
    Machine::create<MachineTnt>, pmAns_devices, ans_settings_604e, HWCompType::MACHINE,
