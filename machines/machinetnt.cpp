...
class MachineTnt : virtual public HWComponent {
...
static const PropMap pm7500_settings_ ## cpu = { \
    {"rambank0_size" , new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    ...
    {"rambank5_size" , new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank6_size" , new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank7_size" , new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank8_size" , new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank9_size" , new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank10_size", new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank11_size", new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"rambank12_size", new IntProperty( 0, vector<uint32_t>({0, 4, 8, 16, 32, 64, 128}))}, \
    {"emmo", new BinProperty(0)}, \
    {"cpu", new StrProperty(# cpu, vector<std::string>({"601", "604", "604e", "750"}))}, \
};
...
static const DeviceDescription MachineTnt7300_descriptor = {
    MachineTnt::create, pm7500_devices, pm7500_settings_604e, HWCompType::MACHINE, "Power Macintosh 7300"
};

static const DeviceDescription MachineTnt7500_descriptor = {
    MachineTnt::create, pm7500_devices, pm7500_settings_601, HWCompType::MACHINE, "Power Macintosh 7500"
};

static const DeviceDescription MachineTnt8500_descriptor = {
    MachineTnt::create, pm8500_devices, pm7500_settings_604, HWCompType::MACHINE, "Power Macintosh 8500"
};

static const DeviceDescription MachineTnt9500_descriptor = {
    MachineTnt::create, pm9500_devices, pm7500_settings_604, HWCompType::MACHINE, "Power Macintosh 9500"
};

static const DeviceDescription MachineTnt7600_descriptor = {
    MachineTnt::create, pm7500_devices, pm7500_settings_604e, HWCompType::MACHINE, "Power Macintosh 7600"
};

static const DeviceDescription MachineTnt8600_descriptor = {
    MachineTnt::create, pm8500_devices, pm7500_settings_604e, HWCompType::MACHINE, "Power Macintosh 8600"
};

static const DeviceDescription MachineTnt9600_descriptor = {
    MachineTnt::create, pm9500_devices, pm7500_settings_604e, HWCompType::MACHINE, "Power Macintosh 9600"
};
