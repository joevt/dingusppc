...
int AtaHardDisk::perform_command() {
    ...
    case READ_DMA_NR: {
            ...
            LOG_F(READWRITE, "%s %lld %d",
                ...
                this->r_command == READ_DMA          ? "READ_DMA"          :
                this->r_command == READ_DMA_NR       ? "READ_DMA_NR"       :
                                                       "UNKNOWN"           ,
            ...
            if (is_dma_cmd) {
                ...
                if (this->signal_ready_timer.active)
                    LOG_F(ERROR, "%s: signal_ready_timer is already active", this->get_name_and_unit_address().c_str());
    ...
    case WRITE_DMA_NR: {
            ...
            this->post_xfer_action = [this]() {
                ...
                LOG_F(READWRITE, "%s %lld %lld",
                    ...
                    this->r_command == WRITE_DMA          ? "WRITE_DMA"          :
                    this->r_command == WRITE_DMA_NR       ? "WRITE_DMA_NR"       :
                                                            "UNKNOWN"            ,
