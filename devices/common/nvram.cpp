...
NVram::NVram(std::string file_name, uint32_t ram_size)
    : HWComponent(ram_size == 256 ? "PRAM" : "NVRAM")
{
...
static const DeviceDescription Pram_Descriptor = {
    NVram::create_pram, {}, {}, HWCompType::PRAM
};

static const DeviceDescription Nvram_Copland_Descriptor = {
    NVram::create_nvram_copland, {}, {}, HWCompType::NVRAM
};

REGISTER_DEVICE(NVRAM, Nvram_Descriptor);
REGISTER_DEVICE(PRAM, Pram_Descriptor);
REGISTER_DEVICE(NVRAMCopland, Nvram_Copland_Descriptor);
