...
promise20269::promise20269()
    : PCIDevice("Promise20269"), HWComponent("Promise20269")
{
    ...
    if (this->attach_exp_rom_image(std::string("sonnettempotrio.bin"))) {
...
uint32_t promise20269::pci_cfg_read(uint32_t reg_offs, AccessDetails &details)
{
    if (reg_offs < 64) {
    ...
    switch (reg_offs) {
        case 0x40: return 0x7E020001;
            ...
            // +2: 7E02 = 01111 1 1 000 0 0 0 010 : Power Management version 2; Flags: PMEClk- DSI- D1+ D2+ AuxCurrent=0mA PME(D0+,D1+,D2+,D3hot+,D3cold-)
...
void promise20269::pci_cfg_write(uint32_t reg_offs, uint32_t value, AccessDetails &details)
{
    if (reg_offs < 64) {
