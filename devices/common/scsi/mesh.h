...
public:
    ...
    static std::unique_ptr<HWComponent> create_for_tnt() {
        return std::unique_ptr<MeshController>(new MeshController(TntMeshID, "MeshTnt"));
    }

    static std::unique_ptr<HWComponent> create_for_heathrow() {
        return std::unique_ptr<MeshController>(new MeshController(HeathrowMeshID, "MeshHeathrow"));
    }
...
public:
    MeshControllerDev(const std::string name)
        : ScsiBusControllerDev(name), HWComponent(name) {}
    ~MeshControllerDev() = default;

    static std::unique_ptr<HWComponent> create() {
        return std::unique_ptr<MeshControllerDev>(new MeshControllerDev("MeshDev"));
    }
