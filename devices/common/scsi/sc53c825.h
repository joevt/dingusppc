...
class Sc53C825PCI : public PCIDevice {
public:
    Sc53C825PCI(const std::string &dev_name);
    ~Sc53C825PCI() = default;

    static std::unique_ptr<HWComponent> create(const std::string &dev_name) {
        return std::unique_ptr<Sc53C825PCI>(new Sc53C825PCI(dev_name));
    }
...
class Sc53C825 : public DmaDevice, virtual public HWComponent {
...
class Sc53C825Dev : public ScsiDevice {
public:
