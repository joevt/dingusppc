...
enum {
    ...
    CUDA_GET_ROM_SIZE        = 0x04,
    CUDA_GET_ROM_BASE        = 0x05,
    CUDA_GET_ROM_HEADER      = 0x06,
    ...
    CUDA_SET_KBRD_NMI        = 0x1C,
    CUDA_SET_POST_PARSE      = 0x1D,
    CUDA_SET_HANG_THRESHOLD  = 0x1E,
    CUDA_GET_HANG_THRESHOLD  = 0x1F,
    CUDA_SET_DEFAULT_DFAC    = 0x20,
    CUDA_SET_POWER_MESSAGES  = 0x21,
    CUDA_READ_WRITE_I2C      = 0x22, /* read/write I2C device */
    CUDA_SET_WAKEUP          = 0x23,
    CUDA_TIMER_TICKLE        = 0x24, /* shutdown timer tickle */
