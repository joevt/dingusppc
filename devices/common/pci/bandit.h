...
public:
    ...
    static std::unique_ptr<HWComponent> create_first() {
        return std::unique_ptr<Bandit>(new Bandit(1, "Bandit1"));
    }

    static std::unique_ptr<HWComponent> create_second() {
        return std::unique_ptr<Bandit>(new Bandit(2, "Bandit2"));
    }

    static std::unique_ptr<HWComponent> create_psx_first() {
        return std::unique_ptr<Bandit>(new Bandit(1, "PsxPci1", 8, 0));
    }
...
public:
    ...
    static std::unique_ptr<HWComponent> create() {
        return std::unique_ptr<AspenPci>(new AspenPci("AspenPci1"));
    }
};
