...
typedef struct {
    ...
    union {
        ed2_t ed2;
        uint32_t TDQueueHeadPointer; // aka NextTD or NextTransferDescriptor; GeneralTransferDescriptor_t or IsochronousTransferDescriptor_t depending on Format
    };
    uint32_t NextED;
...
#undef PROC_REG_PORT
    ...
    bool TransmitPacket(EndpointDescriptor_t &edh, GeneralTransferDescriptor_t &tdh, uint8_t *data1, uint32_t size1, uint8_t *data2, uint32_t size2, uint32_t &bytes_transmitted, bool &ACK, bool &NAK, ConditionCode_t &condition_code);
    bool ReceivePacket (EndpointDescriptor_t &edh, GeneralTransferDescriptor_t &tdh, uint8_t *data1, uint32_t size1, uint8_t *data2, uint32_t size2, uint32_t &bytes_transmitted, bool &ACK, bool &NAK, ConditionCode_t &condition_code);
