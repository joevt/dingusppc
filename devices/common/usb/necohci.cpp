    ...
    : USBHostOHCI("NecOhci"), HWComponent("NecOhci")
{
    ...
    */
    ...
    this->RhDescriptorA.NumberDownstreamPorts     = 2; // normally 2 ports. We can set this to 15 and Open Firmware will probe all the ports.
...
uint32_t necohci::pci_cfg_read(uint32_t reg_offs, AccessDetails &details)
{
    switch (reg_offs) {
