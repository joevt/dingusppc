...
/*
	{ 100, kDMSModeReady, kDisplay_512x384i_60Hz_NTSC,        kDisplay_512x384i_60Hz_NTSC, timingAppleNTSC_ST,         512,  384 },
	{ 102, kDMSModeReady, kDisplay_640x480i_50Hz_PAL,         kDisplay_640x480i_50Hz_PAL,  timingApplePAL_ST,          640,  480 },
	{ 103, kDMSModeReady, kDisplay_640x480i_60Hz_NTSC,        kDisplay_640x480i_60Hz_NTSC, timingAppleNTSC_FF,         640,  480 },
	{ 108, kDMSModeReady, kDisplay_768x576i_50Hz_PAL,         kDisplay_768x576i_50Hz_PAL,  timingApplePAL_FF,          768,  576 },
...
//
	{ 200, DISP(kDisplay_640x480i_60Hz_NTSC    ), timingAppleNTSC_FF             ,   640,   480,   12270000,   640,   664,   724,   780,    480,   486,   492,   525, 0, 0, true , false }, //  15700000  15730769     30769 //  60000000  59926739     73260 // Designing_Cards_and_Drivers_for_the_Macintosh_Family_2nd_Edition_1990.pdf
...
//	{ 226, DISP(kDisplay_1024x768i_87Hz        ), timingInvalid                  ,  1024,   768,   44900000,  1024,  1032,  1208,  1264,    768,   769,   777,   817, 0, 0, true , false }, //  35522000  35522151       151 //  87000000  86957532     42467 // colorsync_20_displays.pdf
...
//	{ 311, DISP(kDisplay_1024x768i_87Hz        ), timingInvalid                  ,  1024,   768,   44900000,  1024,  1032,  1208,  1264,    768,   769,   777,   817, P, P, true , false }, // Byte 0x24, Bit 4 // DMT 0x0f // Vfront 0; Vback 20; Vfront +0.5 Odd Field; Vback +0.5 Even Field
...
//	{ 360, DISP(kDisplay_1920x1440_75Hz        ), timingVESA_1920x1440_75hz      ,  1920,  1440,  297000000,  1920,  2064,  2288,  2640,   1440,  1441,  1444,  1500, N, P, false, false }, // Byte 0x0b, Bit 4 // DMT 0x4a
	...
	{ 415, DISP(kDisplay_1024x768i_87Hz        ), timingInvalid                  ,  1024,   768,   44900000,  1024,  1032,  1208,  1264,    768,   769,   777,   817, P, P, true , false }, // DMT 0x0f // Vfront 0; Vback 20; Vfront +0.5 Odd Field; Vback +0.5 Even Field
...
//	{ 504, DISP(kDisplay_1280x720_60Hz         ), timingInvalid                  ,  1280,   720,   74250000,  1280,  1390,  1430,  1650,    720,   725,   730,   750, P, P, false, false }, // VIC   4 // DMT 0x55 // STD: 0x81 0xc0 // VIC  69
	{ 505, DISP(kDisplay_1920x1080i_60Hz       ), timingInvalid                  ,  1920,  1080,   74250000,  1920,  2008,  2052,  2200,   1080,  1082,  1087,  1103, P, P, true , false }, // VIC   5
	{ 506, DISP(kDisplay_1440x480i_60Hz        ), timingInvalid                  ,  1440,   480,   27000000,  1440,  1478,  1602,  1716,    480,   484,   487,   503, N, N, true , false }, // VIC   6 // VIC   7
//	{ 507, DISP(kDisplay_1440x480i_60Hz        ), timingInvalid                  ,  1440,   480,   27000000,  1440,  1478,  1602,  1716,    480,   484,   487,   503, N, N, true , false }, // VIC   7 // VIC   6
...
//	{ 509, DISP(kDisplay_1440x240_60Hz         ), timingInvalid                  ,  1440,   240,   27000000,  1440,  1478,  1602,  1716,    240,   244,   247,   262, N, N, false, false }, // VIC   9 // VIC   8
	{ 510, DISP(kDisplay_2880x480i_60Hz        ), timingInvalid                  ,  2880,   480,   54000000,  2880,  2956,  3204,  3432,    480,   484,   487,   503, N, N, true , false }, // VIC  10 // VIC  11
//	{ 511, DISP(kDisplay_2880x480i_60Hz        ), timingInvalid                  ,  2880,   480,   54000000,  2880,  2956,  3204,  3432,    480,   484,   487,   503, N, N, true , false }, // VIC  11 // VIC  10
...
//	{ 518, DISP(kDisplay_720x576_50Hz          ), timingInvalid                  ,   720,   576,   27000000,   720,   732,   796,   864,    576,   581,   586,   625, N, N, false, false }, // VIC  18 // VIC  17
	...
	{ 520, DISP(kDisplay_1920x1080i_50Hz       ), timingInvalid                  ,  1920,  1080,   74250000,  1920,  2448,  2492,  2640,   1080,  1082,  1087,  1103, P, P, true , false }, // VIC  20
	{ 521, DISP(kDisplay_1440x576i_50Hz        ), timingInvalid                  ,  1440,   576,   27000000,  1440,  1464,  1590,  1728,    576,   578,   581,   601, N, N, true , false }, // VIC  21 // VIC  22
//	{ 522, DISP(kDisplay_1440x576i_50Hz        ), timingInvalid                  ,  1440,   576,   27000000,  1440,  1464,  1590,  1728,    576,   578,   581,   601, N, N, true , false }, // VIC  22 // VIC  21
...
//	{ 524, DISP(kDisplay_1440x288_50Hz         ), timingInvalid                  ,  1440,   288,   27000000,  1440,  1464,  1590,  1728,    288,   290,   293,   312, N, N, false, false }, // VIC  24 // VIC  23
	{ 525, DISP(kDisplay_2880x576i_50Hz        ), timingInvalid                  ,  2880,   576,   54000000,  2880,  2928,  3180,  3456,    576,   578,   581,   601, N, N, true , false }, // VIC  25 // VIC  26
//	{ 526, DISP(kDisplay_2880x576i_50Hz        ), timingInvalid                  ,  2880,   576,   54000000,  2880,  2928,  3180,  3456,    576,   578,   581,   601, N, N, true , false }, // VIC  26 // VIC  25
...
//	{ 538, DISP(kDisplay_2880x576_50Hz         ), timingInvalid                  ,  2880,   576,  108000000,  2880,  2928,  3184,  3456,    576,   581,   586,   625, N, N, false, false }, // VIC  38 // VIC  37
	{ 539, DISP(kDisplay_1920x1080i_50Hz_72MHz ), timingInvalid                  ,  1920,  1080,   72000000,  1920,  1952,  2120,  2304,   1080,  1103,  1108,  1165, P, N, true , false }, // VIC  39
	{ 540, DISP(kDisplay_1920x1080i_100Hz      ), timingInvalid                  ,  1920,  1080,  148500000,  1920,  2448,  2492,  2640,   1080,  1082,  1087,  1103, P, P, true , false }, // VIC  40
...
//	{ 543, DISP(kDisplay_720x576_100Hz         ), timingInvalid                  ,   720,   576,   54000000,   720,   732,   796,   864,    576,   581,   586,   625, N, N, false, false }, // VIC  43 // VIC  42
	{ 544, DISP(kDisplay_1440x576i_100Hz       ), timingInvalid                  ,  1440,   576,   54000000,  1440,  1464,  1590,  1728,    576,   578,   581,   601, N, N, true , false }, // VIC  44 // VIC  45
//	{ 545, DISP(kDisplay_1440x576i_100Hz       ), timingInvalid                  ,  1440,   576,   54000000,  1440,  1464,  1590,  1728,    576,   578,   581,   601, N, N, true , false }, // VIC  45 // VIC  44
	{ 546, DISP(kDisplay_1920x1080i_120Hz      ), timingInvalid                  ,  1920,  1080,  148500000,  1920,  2008,  2052,  2200,   1080,  1082,  1087,  1103, P, P, true , false }, // VIC  46
...
//	{ 549, DISP(kDisplay_720x480_120Hz         ), timingInvalid                  ,   720,   480,   54000000,   720,   736,   798,   858,    480,   489,   495,   525, N, N, false, false }, // VIC  49 // VIC  48
	{ 550, DISP(kDisplay_1440x480i_120Hz       ), timingInvalid                  ,  1440,   480,   54000000,  1440,  1478,  1602,  1716,    480,   484,   487,   503, N, N, true , false }, // VIC  50 // VIC  51
//	{ 551, DISP(kDisplay_1440x480i_120Hz       ), timingInvalid                  ,  1440,   480,   54000000,  1440,  1478,  1602,  1716,    480,   484,   487,   503, N, N, true , false }, // VIC  51 // VIC  50
...
//	{ 553, DISP(kDisplay_720x576_200Hz         ), timingInvalid                  ,   720,   576,  108000000,   720,   732,   796,   864,    576,   581,   586,   625, N, N, false, false }, // VIC  53 // VIC  52
	{ 554, DISP(kDisplay_1440x576i_200Hz       ), timingInvalid                  ,  1440,   576,  108000000,  1440,  1464,  1590,  1728,    576,   578,   581,   601, N, N, true , false }, // VIC  54 // VIC  55
//	{ 555, DISP(kDisplay_1440x576i_200Hz       ), timingInvalid                  ,  1440,   576,  108000000,  1440,  1464,  1590,  1728,    576,   578,   581,   601, N, N, true , false }, // VIC  55 // VIC  54
...
//	{ 557, DISP(kDisplay_720x480_240Hz         ), timingInvalid                  ,   720,   480,  108000000,   720,   736,   798,   858,    480,   489,   495,   525, N, N, false, false }, // VIC  57 // VIC  56
	{ 558, DISP(kDisplay_1440x480i_240Hz       ), timingInvalid                  ,  1440,   480,  108000000,  1440,  1478,  1602,  1716,    480,   484,   487,   503, N, N, true , false }, // VIC  58 // VIC  59
//	{ 559, DISP(kDisplay_1440x480i_240Hz       ), timingInvalid                  ,  1440,   480,  108000000,  1440,  1478,  1602,  1716,    480,   484,   487,   503, N, N, true , false }, // VIC  59 // VIC  58
