    ...
    if (unit_address == -1) {
        ...
        if (property == "num_displays") {
            if (this->override_property(property, value)) {
                ...
                this->regs_size = ((DingusVideoRegsMeta::MAX_REG + this->num_displays * DingusVideoRegsDisplay::MAX_REG)
                    * sizeof(uint32_t) + 4095) & ~4095;
            }
        }
...
static const char * get_name_dingusvideoreg(int reg)
{
    ...
    case DingusVideoRegsDisplay::HFRONT               : return "HFRONT";
    case DingusVideoRegsDisplay::HBACK                : return "HBACK";
    case DingusVideoRegsDisplay::HTOTAL               : return "HTOTAL";
    case DingusVideoRegsDisplay::VACTIVE              : return "VACTIVE";
    case DingusVideoRegsDisplay::VFRONT               : return "VFRONT";
    case DingusVideoRegsDisplay::VBACK                : return "VBACK";
...
uint32_t DingusVideo::read(uint32_t rgn_start, uint32_t offset, int size)
{
    ...
    if (rgn_start == this->regs_base) {
        ...
        if (reg < DingusVideoRegsMeta::MAX_REG) {
            reg = ~reg;
            DO_READ(this, this->num_displays);
        }
        else {
            DingusVideoCtrl* ctrl = nullptr;
            reg -= DingusVideoRegsMeta::MAX_REG;
            uint32_t unit_address = reg / DingusVideoRegsDisplay::MAX_REG;
            reg %= DingusVideoRegsDisplay::MAX_REG;
            ...
            if (ctrl) {
                switch (reg) {
                    ...
                    case DingusVideoRegsDisplay::HFRONT               : DO_READ(ctrl, ctrl->staged.hfront); break;
                    case DingusVideoRegsDisplay::HBACK                : DO_READ(ctrl, ctrl->staged.hback); break;
                    ...
                    case DingusVideoRegsDisplay::VFRONT               : DO_READ(ctrl, ctrl->staged.vfront); break;
                    case DingusVideoRegsDisplay::VBACK                : DO_READ(ctrl, ctrl->staged.vback); break;
        ...
        if (reg < DingusVideoRegsMeta::MAX_REG) {
            ...
            if (ctrl) {
                switch (reg) {
                    ...
                    case DingusVideoRegsDisplay::HFRONT               : DO_WRITE(ctrl, ctrl->staged.hfront); break;
                    case DingusVideoRegsDisplay::HBACK                : DO_WRITE(ctrl, ctrl->staged.hback); break;
                    ...
                    case DingusVideoRegsDisplay::VFRONT               : DO_WRITE(ctrl, ctrl->staged.vfront); break;
                    case DingusVideoRegsDisplay::VBACK                : DO_WRITE(ctrl, ctrl->staged.vback); break;
