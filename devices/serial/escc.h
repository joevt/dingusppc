...
public:
    ...
    static std::unique_ptr<HWComponent> create() {
        return std::unique_ptr<EsccChannel>(new EsccChannel("EsccChannel"));
    }
...
public:
    EsccController(bool for_pdm);
    ~EsccController() = default;

    static std::unique_ptr<HWComponent> create() {
        return std::unique_ptr<EsccController>(new EsccController(false));
    }
    static std::unique_ptr<HWComponent> create_pdm() {
        return std::unique_ptr<EsccController>(new EsccController(true));
    }
