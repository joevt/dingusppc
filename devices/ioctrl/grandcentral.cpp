    ...
    : PCIDevice(name), InterruptCtrl(), HWComponent(name)
{
    ...
    this->escc->connect_dma_channel(CH_A, DIR_TX, this->escc_a_tx_dma.get());
    this->escc->connect_dma_channel(CH_A, DIR_RX, this->escc_a_rx_dma.get());
    this->escc->connect_dma_channel(CH_B, DIR_TX, this->escc_b_tx_dma.get());
    this->escc->connect_dma_channel(CH_B, DIR_RX, this->escc_b_rx_dma.get());
...
void GrandCentral::setup_intsrc_map()
{
    ...
    this->add_intsrc(IntSrc::ERROR          , INT_TO_IRQ_ID(0x15)); // EXT1
    this->add_intsrc(IntSrc::PCI_FW0        , INT_TO_IRQ_ID(0x16)); // EXT2
    this->add_intsrc(IntSrc::PCI_SLOT1      , INT_TO_IRQ_ID(0x17)); // EXT3
    this->add_intsrc(IntSrc::PCI_SLOT2      , INT_TO_IRQ_ID(0x18)); // EXT4
    this->add_intsrc(IntSrc::PCI_SLOT3      , INT_TO_IRQ_ID(0x19)); // EXT5
    this->add_intsrc(IntSrc::PCI_FW1        , INT_TO_IRQ_ID(0x1A)); // EXT6
    this->add_intsrc(IntSrc::PCI_SLOT4      , INT_TO_IRQ_ID(0x1B)); // EXT7
    this->add_intsrc(IntSrc::PCI_SLOT5      , INT_TO_IRQ_ID(0x1C)); // EXT8
    this->add_intsrc(IntSrc::PCI_SLOT6      , INT_TO_IRQ_ID(0x1D)); // EXT9
    this->add_intsrc(IntSrc::SEC_TO_PRI     , INT_TO_IRQ_ID(0x1E)); // EXT10
}
